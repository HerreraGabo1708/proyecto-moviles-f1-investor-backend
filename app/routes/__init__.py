...
from app.routes.sync_jolpica import sync_jolpica_bp
from app.routes.market_history import market_history_bp
from app.routes.sync_logs import sync_logs_bp
...
def register_routes(app):
    ...
    app.register_blueprint(sync_jolpica_bp)
    app.register_blueprint(market_history_bp, url_prefix='/api/market-history')
    app.register_blueprint(sync_logs_bp, url_prefix='/api/sync-logs')